...
public class Deposit {
    ...
    public static void main(String[] args) {
        ...
        JFrame frm = new JFrame("Deposit Money");
        ...
        JLabel withAmount = new JLabel("Enter the Amount to Deposit : ");
        ...
        JButton withButton = new JButton("Cash In");
        p1.add(withButton);
        ...
        withButton.addActionListener(e -> {
            ...
            if (Amt <= 0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Failed to Deposit Money.");
                }
            }
        });
